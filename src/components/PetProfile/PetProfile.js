...
const StudentProfile = (props) => {
    ...
    const [photoURL, setPhotoURL] = useState(require("../../images/profile2.PNG"));
        ...
        <div className="all-profile">
                <div className="petprofile">
                    <div className="image-container">
                        ...
                        <div><button to="/updateprofile" className="btn btn-light fill-app">Fill the application</button></div>
                        <div><button to="/updateprofile" className="btn btn-light edit-profile">Edit pet information</button></div>
                    </div>
